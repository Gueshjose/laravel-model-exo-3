<section id="fC" class="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
    <div class="mx-auto mb-10 lg:max-w-xl sm:text-center">
      <p class="inline-block px-3 py-px mb-4 text-xs font-semibold tracking-wider text-teal-900 uppercase rounded-full bg-teal-accent-400">
        Tous les membres femmes <span class=" font-extrabold text-pink-400">({{$femmesCond->count()}} membres)</span>
      </p>
    ...
    <div class="grid gap-10 mx-auto sm:grid-cols-2 lg:grid-cols-4 lg:max-w-screen-lg">
      @foreach ($femmesCond as $femme )
            <div class="bg-pink-900 rounded">
                ...
                <p class="text-lg text-pink-400 font-bold">{{$femme->nom}}</p>
                <p class="mb-5 text-xs text-pink-400">Age: {{$femme->age}}</p>
